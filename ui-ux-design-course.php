                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="featureContent">
                            ...
                            <p>This course will help you discover creative powers to build top notch customer experiences. You will be employment ready in a couple of months.</p>
                            <div class="featureItem02">
                                <h3>Benefits / Perks</h3>
                                <div class="featureSingle01">
                                    <h4>Internship After Completion</h4>
                                ...
                                <div class="featureSingle01">
                                    ...
                                    <p>Get trained by industry veterans with years of experience working with top tech brands.</p>
                                </div>
                            </div>
                        </div>
                    </div>
